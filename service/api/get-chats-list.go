...
func (rt *_router) listOfChats(w http.ResponseWriter, r *http.Request, ps httprouter.Params, ctx *reqcontext.RequestContext) {
	...
	chats, err := rt.db.GetChats(ctx.UserID)
	if err != nil {
